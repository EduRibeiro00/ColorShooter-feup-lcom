...
//---------
//NOTA: estes dois metodos, por agora, nao tem em atencao o facto de haver background preto (nao devia copiar nem eliminar pixeis pretos, para poder haver sobreposicao parcial de sprites)
